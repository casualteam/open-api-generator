...
object MediaTypeModel {
  ...
  case class OctetStream(model: Model) extends MediaTypeModel

  def fold[T](mediaTypeModel: MediaTypeModel)(_1: ApplicationJson => T, _2: ApplicationXml => T, _3: ApplicationForm => T, _4: MultipartForm => T, _5: OctetStream => T): T = {
